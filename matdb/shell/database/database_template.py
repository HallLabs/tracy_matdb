"""The Database Template script is meant to be copied and updated to add a new
group to the matdb shell.
    The naming convention "GroupName_group.py" and the
location "matdb/matdb/shell/database/GroupName_group.py" are important.
...
False, whenever database setup begins."""
        parameters.update({'type': 'directory',
                           'root': '../../databases',  # Path from cwd to root.
                           'exempt': False,
                           'exempt_message': exempt_message,
